/*
 * Variant of Telit Charlie Board rev 1.0
 *
 */
...
/*
 ...
 | 06         | D6               |  PA20  |   USER_BUTTON   |  *04   |     |     | X08 |     |   5/02  |   3/02  |        |*TCC0/6 | I2S/SCK0 | GCLK_IO4 |
 | 07         | D7               |  PA21  |   LED_BUILTIN   |  *05   |     |     | X09 |     |   5/03  |   3/03  |        |*TCC0/7 | I2S/FS0  | GCLK_IO5 |
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 */
...
/*
 ...
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 |            |    ACC. INT      |        |                 |        |     |     |     |     |         |         |        |        |          |          |
 | 25         |    ACC. INT 1    |  PB09  |                 |  *09   |  03 |     | Y15 |     |         |   4/01  |  TC4/1 |        |          |          |
 | 26         |    ACC. INT 1    |  PA18  |                 |  *02   |     |     | X06 |     |   1/02  |   3/02  |  TC3/0 | TCC0/2 |          | AC/CMP0  |
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 | 27         |                  |  PB08  | Telit ON/OFF    |   08   |  02 |     | Y14 |     |         |   4/00  |  TC4/0 |        |          |          |
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 */

  { PORTB,  9, PIO_EXTINT,     (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9 },
  { PORTA, 18, PIO_EXTINT,     (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_2 },
...
/*
 ...
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 |            |   Telit Module   |        |                 |        |     |     |     |     |         |         |        |        |          |          |
 | 28         |                  |  PA12  | TX              |   12   |     |     |     |     |   2/00  |  *4/00  | TCC2/0 | TCC0/6 |          | AC/CMP0  |
 | 29         |                  |  PA13  | RX              |   13   |     |     |     |     |   2/01  |  *4/01  | TCC2/1 | TCC0/7 |          | AC/CMP1  |
 | 30         |                  |  PA14  | RTS             |   14   |     |     |     |     |   2/02  |  *4/02  |  TC3/0 | TCC0/4 |          | GCLK_IO0 |
 | 31         |                  |  PA15  | CTS             |   15   |     |     |     |     |   2/03  |  *4/03  |  TC3/1 | TCC0/5 |          | GCLK_IO1 |
 | 32         |                  |  PA27  | DTR             |   15   |     |     |     |     |         |         |        |        |          | GCLK_IO0 |
 | 33         |                  |  PA28  | RI              |   08   |     |     |     |     |         |         |        |        |          | GCLK_IO0 |
 +------------+------------------+--------+-----------------+--------+-----+-----+-----+-----+---------+---------+--------+--------+----------+----------+
 */
                                                                                                                                               // DIPO=3 DOPO=0
  ...
  { PORTA, 14, PIO_SERCOM_ALT, (PIN_ATTR_NONE                                ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SS:   as GPIO
